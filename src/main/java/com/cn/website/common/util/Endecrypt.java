...
public class Endecrypt {
	 ...
	 * @return
	 */
	public static String getSiteEncrypt(String spKey){
		spKey = get3DESEncrypt(spKey,webKey);
		return spKey;
	}
	/**
	 * 站点解密算法
	 ...
	 * @return
	 */
	public static String getSiteDecrypt(String spKey){
		spKey = get3DESDecrypt(spKey, webKey);
		return spKey;
	}
	...
	public static void main(String[] args) {
		...
		//加密串
		String key=getSiteEncrypt(oldString);
        System.out.println(key);
        //解密串
        System.out.println(getSiteDecrypt(key));
